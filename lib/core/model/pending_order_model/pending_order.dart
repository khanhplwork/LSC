...
List<PendingOrder> pendingOrderFromJson(String str) => List<PendingOrder>.from(json.decode(str).map((x) => PendingOrder.fromJson(x)));

String pendingOrderToJson(List<PendingOrder> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
